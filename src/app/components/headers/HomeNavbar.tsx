...
export default function HomeNavbar(props: HomeNavbarProps) {
  const { setSignupOpen, setLoginOpen, handleLogoutClick, anchorEl, handleCloseLogout, handleLogoutRequest } = props; //destruction: props ichidan onAdd ni olishni talab qilamiz
